...
When ``YIALPHA_BINANCE_HTTP_KEEPALIVE=true``, every Binance GET in the process
...
handshake. Mirrors :mod:`yialpha.llm_clients.http_client` (the LLM-side
...
:func:`yialpha.dataflows.utils.proxy_map` already does — the SOCKS5 proxy in
