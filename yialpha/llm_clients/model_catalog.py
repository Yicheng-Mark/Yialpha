...
_GLM_MODELS: dict[str, list[ModelOption]] = {
    "quick": [
        ("GLM-5.3-Flash - Fast, switchable thinking modes", "glm-5.3-flash"),
    ...
    "deep": [
        ("GLM-5.3 - Latest flagship", "glm-5.3"),
        ("GLM-5.2 - Previous flagship, 1M ctx", "glm-5.2"),
...
MODEL_OPTIONS: ProviderModeOptions = {
    ...
    # sync with the .env YIALPHA_QUICK_THINK_LLM=deepseek-v4-flash default.
    "deepseek": {
        "quick": [
