...
(function () {
  ...
  const DICT = {
    zh: {
      ...
      tip_entry: "参考入场价位",
      tip_leverage: "确定性计算的建议杠杆上限（爆仓距离/波动率/信心/硬顶四重约束取最小）",
      tip_liq: "隔离保证金预估强平价（零维持保证金近似，实际触发更远）",
      tip_funding: "近 7 日资金费净和（正=多头支付）",
      tip_asset_badge: "本次分析的市场/资产类别（PERP=币安 USDT-M 永续）",
      kpi_leverage: "建议杠杆",
      kpi_liq: "预估强平价",
      kpi_funding: "资金费 7日",
    ...
    en: {
      ...
      tip_leverage: "Deterministic suggested leverage cap (min of liquidation-distance / volatility / conviction / hard caps)",
      tip_liq: "Estimated isolated-margin liquidation price (zero-MMR approximation; the real trigger is further away)",
      tip_funding: "Net trailing-7d funding (positive = longs pay)",
      tip_asset_badge: "Market/asset class of this run (PERP = Binance USDT-M perpetual)",
      kpi_leverage: "Leverage",
      kpi_liq: "Est. Liq. Price",
      kpi_funding: "Funding 7d",
